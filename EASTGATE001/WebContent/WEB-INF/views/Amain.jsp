	...
	<div id="wrap">
		<header>
			<div class="top_header">
				<div class="container">
					<h1>
						<a href="amain.do"> <span class="blind">EAST-GATE</span> <img
					...
					<form action="productNList.do" class="search_form">
			...
			<nav class="gnb_wrap">
				<div class="container">
					<nav id="main_menu">
				        <ul class="list_gnb">
				            <li><a href="productCList.do?pcode=C">패션의류/잡화</a>
				                <div id="mega-menu">
				                    <ul class="list_lnb">
				                        <li><a href="productCList.do?pcode=C0">여성</a></li>
				                        <li><a href="#">티셔츠</a></li>
				                    ...
				                    <ul class="list_lnb">
				                        <li><a href="productCList.do?pcode=C1">남성</a></li>
				                        <li><a href="#">티셔츠</a></li>
				            ...
				            <li><a href="productCList.do?pcode=S">스포츠</a>
				                <div id="mega-menu">
				                    <ul class="list_lnb">
				                        <li><a href="productCList.do?pcode=S0">여성</a></li>
				                    ...
				                    <ul class="list_lnb">
				                        <li><a href="productCList.do?pcode=S1">남성</a></li>
				                        <li><a href="#">언더레이어</a></li>
				                        <li><a href="#">티셔츠</a></li>
				                        <li><a href="#">자켓/집업</a></li>
				                        <li><a href="#">바지</a></li>
				                    ...
				                    <ul class="list_lnb">
				                        <li><a href="productCList.do?pcode=S2">신발</a></li>
				                        <li><a href="#">런닝화</a></li>
				                        <li><a href="#">운동화</a></li>
				                    ...
				                    <ul class="list_lnb">
				                        <li><a href="productCList.do?pcode=S3">잡화</a></li>
				            ...
				            <li><a href="productCList.do?pcode=B">뷰티</a>
				                <div id="mega-menu">
				                    <ul class="list_lnb">
				                        <li><a href="productCList.do?pcode=B0">뷰티</a></li>
				            ...
				            <li><a href="productCList.do?pcode=F">식품</a>
				                <div id="mega-menu">
				                    <ul class="list_lnb">
				                        <li><a href="productCList.do?pcode=F0">건강식품</a></li>
										<li><a href="#">건강즙</a></li>
				            ...
				            <li><a href="productCList.do?pcode=D">가전디지털</a>
				                <div id="mega-menu">
				                    <ul class="list_lnb">
				                        <li><a href="productCList.do?pcode=D0">가전디지털</a></li>
